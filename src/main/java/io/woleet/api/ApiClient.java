...
import io.woleet.api.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("JWTAuth", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.woleet.io/v1
