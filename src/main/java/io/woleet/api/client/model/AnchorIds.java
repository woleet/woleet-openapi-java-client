...
public class AnchorIds {
   ...
   * @return content
  **/
  @ApiModelProperty(example = "null", value = "Array of identifiers of anchors matching the search criteria.")
  ...
  **/
   ...
   * @return totalPages
  **/
  @ApiModelProperty(example = "null", value = "Total number of pages available.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Total number of anchors matching the search criteria.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Number of anchors in the retrieved page.")
  ...
  **/
   ...
   * @return number
  **/
  @ApiModelProperty(example = "null", value = "Index of the retrieved page (from 0).")
