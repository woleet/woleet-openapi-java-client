 ...
 */
@ApiModel(description = "Signer's identity as returned by the identity server, provided as a set of X.500 attributes (see https://www.ietf.org/rfc/rfc4519.txt).")
