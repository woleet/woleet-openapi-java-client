...
public class IdentityVerificationStatus {
  ...
  private Identity signedIdentity;
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, text, certificates, identity, signedIdentity, signedIssuerDomain, key);
  }
