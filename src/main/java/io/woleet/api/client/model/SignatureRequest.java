...
public class SignatureRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "abcdef01-2345-6789-abcd-ef0123456789", value = "Identifier of the signature anchor created by the platform to sign the audit trail data.<br> This property is set only once the audit trail is generated and can be used to retrieve its proof receipt. ")
