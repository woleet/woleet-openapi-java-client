...
public class SignatureRequest {
  ...
  **/
   ...
   * @return _public
  **/
  @ApiModelProperty(value = "`true` (or unset) if the signature anchors created in the scope of this signature request must be public (ie. discoverable by their `signedHash`).<br> `false` if they must be private (ie. not dicoverable).<br> **If this field is not set at creation time, the anchor is public by default.** ")
  ...
  **/
   ...
   * @return anchors
  **/
  @ApiModelProperty(value = "List of signature anchors created in teh scope of this signature request<br> A signature anchor is created each time a new signature is registered.<br> This property is only available to the owner of the signature request. ")
  ...
  **/
   ...
   * @return identityURL
  **/
  @ApiModelProperty(value = "Web hook to use to verify the signee's identity.<br> If set, it is used to verify signees' identity at signature registration time. ")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, lastModified, name, _public, suspended, hashToSign, anchors, deadline, identityURL, maxSignatures, authorizedSignees);
  }
