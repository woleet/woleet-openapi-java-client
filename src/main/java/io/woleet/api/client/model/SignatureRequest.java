...
public class SignatureRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "a3790416-16c3-4182-a310-9ef491c38a4c", value = "Signature request identifier. It is allocated by the platform, and so must not be provided at creation time.")
  ...
  **/
  ...
  public SignatureRequest hashToSign(String hashToSign) {
   ...
   /**
   * SHA256 hash (ie. the fingerprint) of the file to sign.&lt;br&gt; The value must be provided as an hexadecimal lowercase string. The hash of the empty file is forbidden.&lt;br&gt; 
   * @return hashToSign
  **/
  @ApiModelProperty(example = "c1a52fac4179685e102a5c2bca3342661c3b1d17644b5f22c8feec0b503a8a3e", required = true, value = "SHA256 hash (ie. the fingerprint) of the file to sign.<br> The value must be provided as an hexadecimal lowercase string. The hash of the empty file is forbidden.<br> ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1720294759999", value = "Date of activation of the signature request (in milliseconds since Unix epoch).<br> When not set or null, no activation date is applied. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://wids.acme.com/identity", value = "Web hook to use to verify the signers' identity.<br> If set, it is used to verify the identity of the signers at signature registration time. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "a3790416-16c3-4182-a310-9ef491c38a4c", value = "Identifier of the signature anchor created by the platform to sign the audit trail data.<br> This property is set only once the audit trail is generated and can be used to retrieve its proof receipt. ")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, created, lastModified, name, state, callbackURL, vars, lang, _public, hashToSign, activation, deadline, identityURL, fileName, fileURL, maxSignatures, authorizedSignees, watchers, ordered, anchors, auditTrailData, auditTrailAnchorId, proofBundleComplete, testMode);
  }
