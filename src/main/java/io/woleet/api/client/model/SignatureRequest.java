...
public class SignatureRequest {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "`true` (or unset) if the signature request is public (ie. discoverable by its `hashToSign`).<br> `false` if it must be private (ie. not discoverable).<br> **If this property is not set, the signature request is public by default.**<br> **Signature anchors created in the scope of a signature request inherit from its `public` property.** ")
   ...
   * @return hashToSign
  **/
  @ApiModelProperty(required = true, value = "SHA256 hash (ie. the fingerprint) of the original file to sign.<br> The value must be provided as an hexadecimal lowercase string. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Public URL of the original file to sign.<br> If set, the signature application can use it to download and present the file to the signers. ")
