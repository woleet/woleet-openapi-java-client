...
public class ReceiptSignature {
  ...
  **/
  ...
  public ReceiptSignature signature(String signature) {
   ...
   /**
   * Signature of the &#x60;signedHash&#x60; property using the public key &#x60;pubKey&#x60;.
   * @return signature
  **/
  @ApiModelProperty(value = "Signature of the `signedHash` property using the public key `pubKey`.")
