...
public class ReceiptSignature {
  ...
  public ReceiptSignature signedHash(String signedHash) {
   ...
   /**
   * SHA256 hash (ie. the fingerprint) of the signed file.
   * @return signedHash
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "SHA256 hash (ie. the fingerprint) of the signed file.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "X500 Distinguished Name representing the signed identity.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Public key of the signer.<br> **Currently only Bitcoin addresses are supported.** ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Signature of the `signedHash` property using the public key `pubKey`, or, if any of `signedIdentity` or `signedIssuerDomain` is provided, signature of SHA256(`hashToSign` + `signedIdentity` + `signedIssuerDomain`) using the public key `pubKey`. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Web hook to use to verify the signer's identity.")
