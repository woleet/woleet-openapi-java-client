...
public class ReceiptAnchorsNode {
  ...
  public ReceiptAnchorsNode type(String type) {
   ...
   /**
   * Type of the anchor.&lt;br&gt; **Currently only &#39;BTCOpReturn&#39; is supported.** 
   * @return type
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "BTCOpReturn", value = "Type of the anchor.<br> **Currently only 'BTCOpReturn' is supported.** ")
