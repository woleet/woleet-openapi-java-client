...
public class Anchor {
  ...
  **/
  ...
  public Anchor signature(String signature) {
   ...
   /**
   * Signature of the &#x60;signedHash&#x60; property using the public key &#x60;pubKey&#x60;.&lt;br&gt; **Only Bitcoin signatures are currently supported.**&lt;br&gt; **This property must not be provided when creating a data anchor.** 
   * @return signature
  **/
  @ApiModelProperty(value = "Signature of the `signedHash` property using the public key `pubKey`.<br> **Only Bitcoin signatures are currently supported.**<br> **This property must not be provided when creating a data anchor.** ")
