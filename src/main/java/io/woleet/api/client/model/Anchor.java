...
public class Anchor {
  ...
  **/
  ...
  public Anchor signedHash(String signedHash) {
   ...
   /**
   * SHA256 hash (ie. the fingerprint) of the signed data.&lt;br&gt; The value must be provided as an hexadecimal lowercase string.&lt;br&gt; **This property must not be provided when creating a data anchor.** 
   * @return signedHash
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "SHA256 hash (ie. the fingerprint) of the signed data.<br> The value must be provided as an hexadecimal lowercase string.<br> **This property must not be provided when creating a data anchor.** ")
