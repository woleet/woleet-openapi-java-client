...
public class Anchor {
  ...
  **/
  ...
  public Anchor signedHash(String signedHash) {
   ...
   /**
   * SHA256 hash (ie. the fingerprint) of the original data to sign.&lt;br&gt; The value must be provided as an hexadecimal lowercase string. **This property must not be provided when creating a data anchor.** 
   * @return signedHash
  **/
  @ApiModelProperty(value = "SHA256 hash (ie. the fingerprint) of the original data to sign.<br> The value must be provided as an hexadecimal lowercase string. **This property must not be provided when creating a data anchor.** ")
  ...
  **/
  ...
  public Long getTimestamp() {
   ...
   /**
   * Number of confirmations of the Bitcoin block into which the anchoring process occurred.&lt;br&gt; This field is set when the first confirmation of the Bitcoin block occurs, and removed once the block is confirmed at least 6 times.&lt;br&gt; 
   * @return confirmations
  **/
  @ApiModelProperty(value = "Number of confirmations of the Bitcoin block into which the anchoring process occurred.<br> This field is set when the first confirmation of the Bitcoin block occurs, and removed once the block is confirmed at least 6 times.<br> ")
