...
public class Anchor {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "`true` (or unset) if the anchor is public (ie. discoverable by its `hash` or `signedHash`).<br> `false` if it must be private (ie. not discoverable).<br> **If this property is not set, the anchor is public by default.** ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "\"{\\\"title\\\":\\\"Ubik\\\",\\\"author\\\":\\\"Philip K. Dick\\\",\\\"read\\\":true,\\\"rank\\\":10.0}\"", value = "A set of variables (key/values pairs) to store with the anchor and giving additional information about the anchored data.<br> Values must be of type null, boolean, string or number: nested JSON objects are not allowed. ")
