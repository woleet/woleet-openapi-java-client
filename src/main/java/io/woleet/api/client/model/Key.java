...
public class Key {
  ...
  **/
  ...
  @ApiModelProperty(example = "John Doe key", value = "Key name.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1Ddk3zx55biVKXodadBVbRC5txWG7YwGAx", value = "Public key (bitcoin address when using BIP39 keys).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1569542400000", value = "Key expiration date (Unix ms timestamp). <br>Note that this property is not returned if the key has no expiration date. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1569542400000", value = "Key revocation date (Unix ms timestamp). <br>Note that this property is not returned if the key is not yet revoked. ")
