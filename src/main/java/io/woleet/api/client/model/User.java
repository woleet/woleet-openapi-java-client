...
import io.woleet.api.client.model.Info;
...
public class User {
  ...
  /**
   * User role:&lt;br&gt; - ROLE_USER: regular domain user&lt;br&gt; - ROLE_DOMAIN_ADMIN: domain administrator. 
   */
  ...
  /**
   * The status of the user:&lt;br&gt; - PENDING: the user email needs to be validated&lt;br&gt; - APPROVED: the user can loging&lt;br&gt; - DISABLED: the user cannot login 
   */
  ...
  **/
  ...
  @ApiModelProperty(example = "abcdef01-2345-6789-abcd-ef0123456789", value = "User identifier. It is allocated by the platform, and so must not be provided at creation time.")
  ...
  **/
   ...
   * @return email
  **/
  @ApiModelProperty(example = "john.doe@acme.com", required = true, value = "Email of the user.")
  ...
  **/
   ...
   * @return roles
  **/
  @ApiModelProperty(required = true, value = "Array of user roles.")
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The status of the user:<br> - PENDING: the user email needs to be validated<br> - APPROVED: the user can loging<br> - DISABLED: the user cannot login ")
