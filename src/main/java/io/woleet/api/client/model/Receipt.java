 ...
 */
@ApiModel(description = "A proof receipt:<br> - the proof of timestamp is provided as a Chainpoint 2.x proof receipt.<br> - the proof of signature (if applicable) is provided in the `signature` property.<br> If the proof receipt is partial (ie. does not contain the proof of timestamp) Chainpoint 2.x properties are not provided. ")
...
public class Receipt {
  ...
  **/
  ...
  @ApiModelProperty(example = "abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789", value = "Chainpoint 2.x: SHA256 hash of the proven data or signature. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ChainpointSHA256v2", value = "Chainpoint 2.x: Type of the proof receipt.<br> **Currently only 'ChainpointSHA256v2' is supported.** ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "55aaf75bb11ffc925e28940dfa9f0b48ed25ace18d561e41c95dd2aead65cc61", value = "Chainpoint 2.x: Root of the Merkle tree. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "`true` if the receipt is a partial receipt (ie. does not contain the Chainpoint 2.x proof of timestamp). ")
