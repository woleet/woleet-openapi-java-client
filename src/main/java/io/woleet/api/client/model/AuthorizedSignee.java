...
public class AuthorizedSignee {
  ...
  **/
  ...
  public AuthorizedSignee identityURL(String identityURL) {
   ...
   /**
   * Web hook to use to verify the signee&#39;s identity.&lt;br&gt; If set, it is used at signature registration time to create the signature anchor. 
   * @return identityURL
  **/
  @ApiModelProperty(value = "Web hook to use to verify the signee's identity.<br> If set, it is used at signature registration time to create the signature anchor. ")
