...
public class AuthorizedSignee {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://wids.acme.com/identity", value = "Web hook to use to verify the signer's identity.<br> If set, this property overwrites the `identityURL` property defined at signature request level. ")
