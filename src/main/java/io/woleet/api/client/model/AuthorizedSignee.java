...
public class AuthorizedSignee {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"requesterName\":\"ACME Corp.\"}", value = "The set of variables (key/value pairs) to use to customize the signature request workflow for this signer.<br> Values must be of type null, boolean, string or number: nested JSON objects are not allowed.<br> Variables defined here overwrites the ones defined at signature request level when emailing the signer.<br> **This property is only available to the owner and the signers of the signature request.** ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1Ddk3zx55biVKXodadBVbRC5txWG7YwGAx", value = "The public key the signer must use to sign.<br> If not set, the signer can use any key to sign.<br> **Currently only Bitcoin addresses are supported.** ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of device the signer should use to sign: - SERVER: Woleet.ID Server or equivalent - MOBILE: Woleet.ID Mobile or equivalent - NANO: Ledger Nano S or equivalent  If set, the signature application can use it to propose only the corresponding signature mode. ")
  ...
  public AuthorizedSignee identityURL(String identityURL) {
   ...
   /**
   * Web hook of the identity server to use to verify the signer&#39;s identity. If set, this property overwrites the &#x60;identityURL&#x60; property defined at signature request level. 
   * @return identityURL
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://wids.acme.com/identity", value = "Web hook of the identity server to use to verify the signer's identity. If set, this property overwrites the `identityURL` property defined at signature request level. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Signer feedback subject", value = "Last feedback subject reported by the signer to the owner of the signature request.<br> **This property is only available to the owner of the signature request.** ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Signer feedback message", value = "Last feedback message reported by the signer to the owner of the signature request.<br> **This property is only available to the owner of the signature request.** ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "abcdef01-2345-6789-abcd-ef0123456789", value = "If the signer has signed, identifier of the signature anchor created.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1620294759999", value = "If the signer has signed, date of signature (in milliseconds since Unix epoch).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "abcdef01-2345-6789-abcd-ef0123456789", value = "Identifier of the signer in the audit trail.")
