...
public class SignatureRequestSign {
  ...
  **/
  @ApiModelProperty(value = "X500 Distinguished Name representing the signed identity.<br> If set, the CN (common name) and EMAILADDRESS (email address) attributes must match the common name and email address of the authorized signee as set in the signature request. ")
  ...
  **/
   ...
   * @return identityURL
  **/
  @ApiModelProperty(value = "Web hook to use to verify the signee's identity.<br> If set, it is used in place of the `identityURL` property of the authorized signee to create the signature anchor. ")
