...
public class SignatureRequestSign {
   ...
   * @return signature
  **/
  @ApiModelProperty(example = "IGcvQrBq8w7eJDekrOhy9sIqttmicMp47vzf77Dg4PJJfFdZVDVGeHki3pitfWrs6ysoccKUK0xEx7Da2Cb8ljw=", required = true, value = "Signature of the `hashToSign` property of the signature request using the public key `pubKey`, or, if any of `signedIdentity` or `signedIssuerDomain` is provided, signature of SHA256(`hashToSign` + `signedIdentity` + `signedIssuerDomain`) using the public key `pubKey`. ")
   ...
   * @return pubKey
  **/
  @ApiModelProperty(example = "1Ddk3zx55biVKXodadBVbRC5txWG7YwGAx", required = true, value = "Public key used to sign.")
  ...
  **/
  ...
  @ApiModelProperty(example = "CN=John Doe,EMAILADDRESS=john.doe@acme.com", value = "X500 Distinguished Name representing the signed identity.<br> If set, the CN (common name) and EMAILADDRESS (email address) attributes must match the common name and email address of the signer as set in the signature request. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "acme.com", value = "Domain name of the identity issuer (ie. of the organization who verified the identity).<br> If set, the domain name of the identity URL must be included in the `signedIssuerDomain` domain name. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://wids.acme.com/identity", value = "Web hook to use to verify the signer's identity.<br> If set, it is used in place of the `identityURL` property of the signer to create the signature anchor. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "abcdef01-2345-6789-abcd-ef0123456789", value = "Secret identifier of the signer (provided by email).<br> Only required if `pubKey` was not set for thìs signer. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123456", value = "OTP of the signer (only required if `requiresOTP` was set to `true` for thìs signer). ")
