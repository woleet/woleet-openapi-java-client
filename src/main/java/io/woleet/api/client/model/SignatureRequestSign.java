...
public class SignatureRequestSign {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "acme.com", value = "Domain name of the identity server.<br> If set, the domain name of the identity URL must be included in the `signedIssuerDomain` domain name. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "https://wids.acme.com/identity", value = "Web hook of the identity server to use to verify the signer's identity.<br> If set, it is used in place of the `identityURL` property of the signer to create the signature anchor. ")
