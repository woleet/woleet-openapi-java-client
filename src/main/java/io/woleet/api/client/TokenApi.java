...
public class TokenApi {
    ...
    private com.squareup.okhttp.Call getTokenValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Token> getTokenWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getTokenValidateBeforeCall(null, null);
    ...
    public com.squareup.okhttp.Call getTokenAsync(final ApiCallback<Token> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getTokenValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Token>(){}.getType();
