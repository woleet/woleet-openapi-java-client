...
import java.io.File;
import io.woleet.api.client.model.GetSignatureRequestProofBundle;
...
public class SignatureRequestApi {
     ...
     */
    public okhttp3.Call downloadSignatureRequestFileCall(String requestId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call downloadSignatureRequestFileValidateBeforeCall(String requestId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = downloadSignatureRequestFileCall(requestId, _callback);
        return localVarCall;
     ...
     */
    public File downloadSignatureRequestFile(String requestId) throws ApiException {
        ApiResponse<File> localVarResp = downloadSignatureRequestFileWithHttpInfo(requestId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<File> downloadSignatureRequestFileWithHttpInfo(String requestId) throws ApiException {
        okhttp3.Call localVarCall = downloadSignatureRequestFileValidateBeforeCall(requestId, null);
     ...
     */
    public okhttp3.Call downloadSignatureRequestFileAsync(String requestId, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = downloadSignatureRequestFileValidateBeforeCall(requestId, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The signature attestation. </td><td>  -  </td></tr>
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 202 </td><td> A partial proof bundle of the signature request (not all receipts are yet available or some signature are missing). </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Signature request not found. </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @param requestId Identifier of the signature request. (required)
     * @return GetSignatureRequestProofBundle
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public GetSignatureRequestProofBundle getSignatureRequestProofBundle(String requestId) throws ApiException {
        ApiResponse<GetSignatureRequestProofBundle> localVarResp = getSignatureRequestProofBundleWithHttpInfo(requestId);
        return localVarResp.getData();
    }
     ...
     * Use this operation to retrieve the proof bundle of a signature request.&lt;br&gt; The proof bundle is a JSON file containing all the pieces of evidence:&lt;br&gt; - the audit trail&lt;br&gt; - the proof receipt of the signature of the audit trail by the platform&lt;br&gt; - the proof receipts of the signature of the file by the signers&lt;br&gt; Consequently, the proof bundle is only available once all the following conditions are met:&lt;br&gt; - the signature request is COMPLETED (by the platform) or CLOSED (by the requester)&lt;br&gt; - all the proofs receipts are available (ie. have been anchored)&lt;br&gt; - the audit trail is generated and signed by the platform and its proof receipt is available (ie. is anchored)&lt;br&gt; If this endpoint is called before all these conditions are met, it returns only the available proof receipts (with a 202 status).&lt;br&gt; This is a publicly accessible endpoint: authentication is not required to retrieve the proof receipts of a signature request (but its identifier need to be known). 
     * @param requestId Identifier of the signature request. (required)
     * @return ApiResponse&lt;GetSignatureRequestProofBundle&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetSignatureRequestProofBundle> getSignatureRequestProofBundleWithHttpInfo(String requestId) throws ApiException {
        okhttp3.Call localVarCall = getSignatureRequestProofBundleValidateBeforeCall(requestId, null);
        Type localVarReturnType = new TypeToken<GetSignatureRequestProofBundle>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getSignatureRequestProofBundleAsync(String requestId, final ApiCallback<GetSignatureRequestProofBundle> _callback) throws ApiException {
