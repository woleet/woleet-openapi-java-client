...
public class SignatureRequestApi {
     ...
     * @param signeeId Secret identifier of the signee wanting to retrieve his One Time Password.&lt;br&gt; **This secret identifier is generated by the platform and included in the email sent to the signee, allowing the platform to authenticate the signee.**  (required)
