...
public class AnchorApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> The created anchor (for signature anchors, the &#x60;hash&#x60; property is automatically set to the SHA256 of the signature, which is what is actually anchored into the blockchain). </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid anchor object. More details are returned in the response body as a JSON object. </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call searchAnchorIdsCall(Integer page, Integer size, String hash, String signedHash, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchAnchorIdsValidateBeforeCall(Integer page, Integer size, String hash, String signedHash, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = searchAnchorIdsCall(page, size, hash, signedHash, _callback);
        return localVarCall;
    ...
    public AnchorIds searchAnchorIds(Integer page, Integer size, String hash, String signedHash) throws ApiException {
        ApiResponse<AnchorIds> localVarResp = searchAnchorIdsWithHttpInfo(page, size, hash, signedHash);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<AnchorIds> searchAnchorIdsWithHttpInfo(Integer page, Integer size, String hash, String signedHash) throws ApiException {
        okhttp3.Call localVarCall = searchAnchorIdsValidateBeforeCall(page, size, hash, signedHash, null);
     ...
     */
    public okhttp3.Call searchAnchorIdsAsync(Integer page, Integer size, String hash, String signedHash, final ApiCallback<AnchorIds> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchAnchorIdsValidateBeforeCall(page, size, hash, signedHash, _callback);
        Type localVarReturnType = new TypeToken<AnchorIds>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
