...
public class AnchorApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> The created anchor.&lt;br&gt; Note that for signature anchors, the &#x60;hash&#x60; property is automatically set to the SHA256 of the signature, which is what is actually anchored into the blockchain).  </td><td>  -  </td></tr>
