...
public class ReceiptApi {
     ...
     */
    public String getOTSReceipt(String anchorid) throws ApiException {
        ApiResponse<String> resp = getOTSReceiptWithHttpInfo(anchorid);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> getOTSReceiptWithHttpInfo(String anchorid) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getOTSReceiptAsync(String anchorid, final ApiCallback<String> callback) throws ApiException {
