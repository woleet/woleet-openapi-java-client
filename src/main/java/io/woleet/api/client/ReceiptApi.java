...
public class ReceiptApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 202 </td><td> The proof receipt is not ready for this anchor. </td><td>  -  </td></tr>
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The proof receipt (conform to the Chainpoint format). </td><td>  -  </td></tr>
        <tr><td> 202 </td><td> The proof receipt is not ready for this anchor. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> No anchor matching the given identifier. </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Invalid proof receipt object. More details are returned in the response body as a JSON object. </td><td>  -  </td></tr>
     </table>
     */
