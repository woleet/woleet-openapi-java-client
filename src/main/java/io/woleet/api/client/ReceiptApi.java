...
public class ReceiptApi {
    ...
    private com.squareup.okhttp.Call getReceiptCall(String anchorid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/receipt/{anchorid}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<Receipt> getReceiptWithHttpInfo(String anchorid) throws ApiException {
        com.squareup.okhttp.Call call = getReceiptCall(anchorid, null, null);
    ...
    private com.squareup.okhttp.Call verifyReceiptCall(Receipt receipt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/receipt/verify".replaceAll("\\{format\\}","json");
     ...
     * @param receipt Chainpoint standard receipt to verify.  (required)
    ...
    public ApiResponse<ReceiptVerificationStatus> verifyReceiptWithHttpInfo(Receipt receipt) throws ApiException {
        com.squareup.okhttp.Call call = verifyReceiptCall(receipt, null, null);
