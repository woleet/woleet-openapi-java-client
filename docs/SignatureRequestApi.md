 ...
 **signeeId** | **String**| Secret identifier of the signee wanting to retrieve the signature request.&lt;br&gt; When set, information related to the signee is added to the response.&lt;br&gt; **This secret identifier is generated by the platform and included in the email sent to the signee, allowing the platform to authenticate the signee.**  | [optional]
