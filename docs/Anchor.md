...
**notifyByEmail** | **Boolean** | &#x60;true&#x60; if the receipt must be sent by email once available, or &#x60;false&#x60; (or unset) if not.  |  [optional]
...
**txId** | **String** | Identifier of the Bitcoin transaction where the anchoring occurred.&lt;br&gt; **This property is a read-only property managed by the platform: it must not be provided at creation time or modified.**  |  [optional]
