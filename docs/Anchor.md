...
**signedHash** | **String** | SHA256 hash (ie. the fingerprint) of the original data to sign.&lt;br&gt; The value must be provided as an hexadecimal lowercase string. **This property must not be provided when creating a data anchor.**  |  [optional]
